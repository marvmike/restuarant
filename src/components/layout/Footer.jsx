    ...
    <footer className="bg-white pt-16 pb-8 border-t border-gray-200">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="font-bold text-gray-800 mb-4">FOODE</h3>
            <p className="text-gray-600 text-sm">
              Bringing healthy, delicious meals to your doorstep every day.
            </p>
          </div>
          <div>
            <h4 className="font-semibold text-gray-800 mb-4">Company</h4>
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-600 hover:text-green-500">About</a></li>
              <li><a href="#" className="text-gray-600 hover:text-green-500">Careers</a></li>
              <li><a href="#" className="text-gray-600 hover:text-green-500">Contact</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-gray-600">hello@foode.com</li>
              <li className="text-gray-600">+1 (555) 123-4567</li>
              <li className="text-gray-600">123 Food Street, NY 10001</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm mb-4 md:mb-0">
            © 2025 FOODE. All rights reserved.
          </p>
